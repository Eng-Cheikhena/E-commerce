          ...
          <div class="header-right justify-content-end">
            <nav class="main-nav">
              <ul class="menu">
                ...
                <li>
                  <a href="demo19_shop.php">Products</a>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-9 main-content shop-content">
              ...
              require_once './Backend/partner-backend.php';
              ?>
                    ...
                    <div class="owl-carousel widget-featured-products">
                      <div class="featured-col">
                        <div class="product-default left-details product-widget">
                          <figure>
                            <a href="demo19-product.html">
                              <img src="assets/images/demoes/demo19/products/small/product-1.jpg"
                          ...
                          <div class="product-details">
                            ...
                            <div class="price-box">
                              <span class="product-price">MRU5680.00</span>
                            </div><!-- End .price-box -->
                        ...
                        <div class="product-default left-details product-widget">
                          <figure>
                            <a href="#">
                              <img src="assets/images/demoes/demo19/products/small/product-2.jpg"
                                width="75" height="75" alt="product" />
                            </a>
                          </figure>
                          <div class="product-details">
                            <h3 class="product-title">
                              <a href="#">Fifa Football</a>
                            </h3>
                            <div class="ratings-container">
                              <div class="product-ratings">
                            ...
                            <div class="price-box">
                              <span class="product-price">MR590.00</span>
                            </div><!-- End .price-box -->
                          </div><!-- End .product-details -->
                        </div>
                        <div class="product-default left-details product-widget">
                          <figure>
                            <a href="demo19-product.html">
                              <img src="assets/images/demoes/demo19/products/small/product-3.jpg"
                                width="75" height="75" alt="product" />
                            </a>
                          </figure>
                          <div class="product-details">
                            <h3 class="product-title">
                              <a href="demo19-product.html">Cotton Bomber Jacket</a>
                            </h3>
                            <div class="ratings-container">
                              <div class="product-ratings">
                            ...
                            <div class="price-box">
                              <span class="product-price">MRU599.90</span>
                            </div><!-- End .price-box -->
                          </div><!-- End .product-details -->
                        </div>
                      ...
                      <div class="featured-col">
                        <div class="product-default left-details product-widget">
                          ...
                          <div class="product-details">
                            <h3 class="product-title">
                              <a href="demo19-product.html">White Sofa</a>
                            </h3>
                            <div class="ratings-container">
                              <div class="product-ratings">
                                <span class="ratings" style="width:60%"></span>
